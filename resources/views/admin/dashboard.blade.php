    ...
    <div class="dashboard-wrapper">
        ...
        <div class="dashboard-header">
            ...
            <div class="header-actions">
                ...
                <a href="{{ route('admin.rack_map') }}" class="btn btn-primary">
                    <i class="fas fa-th"></i> Visual Map
                </a>
        ...
        <div class="dashboard-stats-grid">
            ...
            <div class="stat-card-custom">
                ...
                <div class="stat-card-body">
                    ...
                    <div class="stat-card-icon-wrapper stat-icon-occupancy">
            ...
            <div class="stat-card-custom">
                ...
                <div class="stat-card-body">
                    ...
                    <div class="stat-card-icon-wrapper stat-icon-users">
                        <i class="fas fa-users"></i>
                    </div>
                </div>
                @if($stats['pending_accounts'] > 0)
                    <p class="stat-card-footer-text alert-text" id="stat-pending-wrapper">
                        <i class="fas fa-exclamation-circle"></i> <span
                            id="stat-pending">{{ $stats['pending_accounts'] }}</span> en attente validation
                    </p>
                @else
                    <p class="stat-card-footer-text" id="stat-pending-wrapper">
        ...
        <div class="reference-grid">
            ...
            <div class="charts-section">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                    <div class="chart-card">
                        <div class="chart-header">
                            <h3 class="chart-title"><i class="fas fa-chart-pie chart-icon-dispo"></i>
                                Disponibilité</h3>
                        </div>
                    ...
                    <div class="chart-card">
                        <div class="chart-header">
                            <h3 class="chart-title"><i class="fas fa-exclamation-circle chart-icon-incident"></i>
                                Incidents</h3>
                        </div>
                        <div style="height: 200px; position: relative;">
                ...
                <div class="chart-card">
                    <div class="chart-header">
                        <h3 class="chart-title"><i class="fas fa-boxes chart-icon-inventory"></i> Inventaire
                            Matériel</h3>
                    </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 24px;">
                <div class="logs-card">
                    <div class="logs-header">
                        <h3 class="chart-title"><i class="fas fa-history chart-icon-logs"></i> Audit Logs</h3>
                        <a href="{{ route('admin.logs') }}" class="view-all-link">Voir
