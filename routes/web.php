...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/api/resources/{resource}/availability', [ReservationController::class, 'getAvailability'])->name('api.resources.availability');
    ...
    Route::middleware(['role:admin,responsable'])->group(function () {
        ...
        Route::patch('/resources/{resource}/toggle-activation', [ResourceController::class, 'toggleActivation'])->name('resources.toggleActivation');
